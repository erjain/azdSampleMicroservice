...
namespace backend.Controllers
{
    ...
    public class PizzaInfoController : ControllerBase
    {
        ...
        {
            new PizzaInfo { PizzaName = "The Mighty ", Ingredients = "cheese", Cost = 40, InStock = "yes" },
            new PizzaInfo { PizzaName = "Apple", Ingredients = "Dungeness and apples", Cost = 35, InStock = "no"},
            new PizzaInfo { PizzaName = "Forest Floor", Ingredients = "Mushrooms, rutabagas, and walnuts", Cost = 20, InStock = "yes" },
            new PizzaInfo { PizzaName = "Don't At Me", Ingredients = "Pineapple, jalapeños", Cost = 25, InStock = "yes"},
